    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3.5 flex flex-col justify-between">
        ...
        <div className="mt-2">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">{t('tokens')} extracted</div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3.5 flex flex-col justify-between">
        ...
        <div className="mt-2">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">{speechRatioPercent}% of audio</div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3.5 flex flex-col justify-between">
        ...
        <div className="mt-2">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">{stats.totalPauseDuration.toFixed(1)}s total gaps</div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3.5 flex flex-col justify-between">
        ...
        <div className="mt-2">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">Mean phonation</div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3.5 flex flex-col justify-between">
        ...
        <div className="mt-2">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5">Max silent interval</div>
        </div>
      </div>
    </div>
  );
